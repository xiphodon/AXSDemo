 ...
 */
public class LookEventFragment02 extends LookEventBaseFragment {

    private TextView tv_look_event_other;
    private String orderSignID;

    public LookEventFragment02(String orderSignID, TextView tv_look_event_other) {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser){
            tv_look_event_other.setText("添加事件");
            tv_look_event_other.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //页面跳转
                    Toast.makeText(getActivity(),"添加事件",Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    public String setUrl() {
        return Utils.URL_ORDER_INCIDENT + "?OrderSignID=" + orderSignID;
    }
}
